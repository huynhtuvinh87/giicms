...
(function (b) {
    ...
    b.fn.uploadFile = function (l) {
        var k = b.extend({url: "", method: "POST", enctype: "multipart/form-data", formData: null, returnType: null, allowedTypes: "*", fileName: "file", multiple: true, dragDrop: true, autoSubmit: true, showCancel: true, showAbort: true, showDone: true, showStatusAfterSuccess: true, showStatusAfterError: true, buttonCss: false, buttonClass: false,
            onSubmit: function (m) {
            }, onBeforeSend: function (n, m, o) {
        ...
        var e = b('<label class="btn btn-success" for="" ><i class="fa fa-pencil"></i> ' + b(this).html() + "</label>");
                ...
                if (this.files) {
                    for (x = 0; x < this.files.length; x++) {
                        if (!d(t, o, this.files[x].name)) {
                            alert("Bạn phải upload file không đúng định dạng như: " + o.allowedTypes);
                            return
                        }
...
//            this.statusbar = b("<div class='ajax-file-upload-statusbar'></div>");
    ...
    b.fn.uploadFile.ajaxFormSubmit = function (h, g, c, e) {
        ...
        var d = {cache: false, contentType: false, processData: false, forceSync: false, data: g.formData, fileData: g.fileData, dataType: g.returnType, beforeSend: function (j, i) {
            ...
            }, beforeSend: function (j, i, k) {
                g.onBeforeSend.call(this, e, j, k);
